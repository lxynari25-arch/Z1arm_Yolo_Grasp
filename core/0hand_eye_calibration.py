"""
1. 拍照；2. 采集对应坐标；3. 计算矩阵参数
"""
import argparse
import sys
import time
from tqdm import tqdm
from iter_capture import LoadStreams
from utils import *
...
sys.path.append("./unitree/z1_sdk/lib")
...
if __name__ == "__main__":
    ...
    realcam = Realsense2(0, 640, 480, 30, is_depth_pix=args.depth_data, is_fps=args.fps)
